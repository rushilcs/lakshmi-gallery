...
test("encodeCloudfrontPathFromS3Key encodes spaces and parentheses per segment", () => {
    const key = "galleries/0db17899-efd4-4bf9-a8cc-819766da40af/original/1770000000000_photo (3)_thumb.jpg";
    const encoded = encodeCloudfrontPathFromS3Key(key);
    assert.equal(encoded, "galleries/0db17899-efd4-4bf9-a8cc-819766da40af/original/1770000000000_photo%20(3)_thumb.jpg");
...
test("buildCloudfrontResourceUrl signs exact encoded resource URL", () => {
    ...
    assert.equal(url, "https://d123.cloudfront.net/galleries/0db17899-efd4-4bf9-a8cc-819766da40af/original/1770000000000_photo%20(3)_thumb.jpg");
});
